...
public class Clock : NSObject {
    ...
    @objc dynamic public class func drawCanvas1(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 134, height: 95), resizing: ResizingBehavior = .aspectFit, timer: CGFloat = 0) {
        ...
        //// Text 2 Drawing
        context.saveGState()
        context.translateBy(x: -4, y: 65)
        context.rotate(by: -90 * CGFloat.pi/180)

        let text2Rect = CGRect(x: 0, y: 0, width: 37, height: 28.6)
        let text2TextContent = "Start"
        let text2Style = NSMutableParagraphStyle()
        text2Style.alignment = .left
        let text2FontAttributes = [
            .font: UIFont(name: "AmericanTypewriter", size: UIFont.systemFontSize)!,
            .foregroundColor: UIColor.black,
        ...
        //// Text 3 Drawing
        context.saveGState()
        context.translateBy(x: 137, y: 26)
        context.rotate(by: -270 * CGFloat.pi/180)

        let text3Rect = CGRect(x: 0, y: 0, width: 44.26, height: 28.6)
